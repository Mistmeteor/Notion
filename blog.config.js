...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '与时间好好和解,尽可能留下宝贵的记忆,这比什么都重要,村上春树',
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Reading Photography Traveling Game', // 作者简介
